    ...
    if (typeof commandHandler.builder === 'function') {
      ...
      if (yargs.parsed === false) {
        if (typeof yargs.getUsageInstance().getUsage() === 'undefined') {
          yargs.usage(usageFromParentCommandsCommandHandler(parentCommands, commandHandler))
        }
      ...
      innerYargs.usage(usageFromParentCommandsCommandHandler(parentCommands, commandHandler))
