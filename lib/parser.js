...
function increment (orig) {
  return typeof orig !== 'undefined' ? orig + 1 : 0
}
...
module.exports = function (args, opts) {
  ...
  for (var i = 0; i < args.length; i++) {
    ...
    // -- seperated by space.
      ...
      // array format = '--foo a b c'
        ...
        if (typeof next !== 'undefined' && !next.match(/^-/) &&
  ...
  function setKey (obj, keys, value) {
    ...
    } else if (typeof o[key] === 'undefined' && checkAllAliases(key, flags.arrays)) {
      o[key] = Array.isArray(value) ? value : [value]
    } else if (typeof o[key] === 'undefined' || typeof o[key] === 'boolean') {
      o[key] = value
