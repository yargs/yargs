...
import type { Dictionary, KeyOf, DictionaryKeyof, ValueOf, RequireDirectoryOptions, PlatformShim, RequireType, nil } from './typings/common-types.js';
...
declare const kEmitWarning: unique symbol;
...
declare const kGetUsageConfiguration: unique symbol;
...
declare const kIsGlobalContext: unique symbol;
...
declare const kTrackManuallySetKeys: unique symbol;
...
export declare class YargsInstance {
    ...
    [kEmitWarning](warning: string, type: string | undefined, deduplicationId: string): void;
    [kFreeze](): void;
