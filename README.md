...
Enable bash-completion shortcuts for commands and arguments.
A corresponding script must be added to a user's `.bashrc`, and is generated by
running `yargs.showCompletionScript()`.

.showCompletionScript()
----------------------

Generate a bash completion script. Your application's users can install this
