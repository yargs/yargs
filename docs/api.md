...
The rest of these methods below come in just before the terminating `.argv`.
  ...
  - [.alias(key, alias)](#aliaskey-alias)
  - [.argv](#argv)
  - [.array(key)](#arraykey)
  - [.boolean(key)](#booleankey)
  - [.check(fn, [global=true])](#checkfn-globaltrue)
  - [.choices(key, choices)](#choiceskey-choices)
  - [.coerce(key, fn)](#coercekey-fn)
  - [.command(cmd, desc, [builder], [handler])](#commandcmd-desc-builder-handler)
  - [.command(cmd, desc, [module])](#commandcmd-desc-module)
  - [.command(module)](#commandmodule)
  - [.completion([cmd], [description], [fn])](#completioncmd-description-fn)
  - [.config([key], [description], [parseFn])](#configkey-description-parsefn)
  - [.config(object)](#configobject)
  - [.conflicts(x, y)](#conflictsx-y)
  - [.count(key)](#countkey)
  - [.default(key, value, [description])](#defaultkey-value-description)
  - [.defaults(key, value, [description])](#defaultskey-value-description)
  - [.demand(count, [max], [msg]) [DEPRECATED]](#demandcount-max-msg-deprecated)
  - [.demandOption(key, [msg | boolean])](#demandoptionkey-msg--boolean)
  - [.demandOption(key, msg)](#demandoptionkey-msg)
  - [.demandCommand([min=1], [minMsg])](#demandcommandmin1-minmsg)
  - [.demandCommand([min=1], [max], [minMsg], [maxMsg])](#demandcommandmin1-max-minmsg-maxmsg)
  - [.deprecateOption(key, [msg | boolean])](#deprecateoptionkey-msg--boolean)
  - [.describe(key, desc)](#describekey-desc)
  - [.hide(key)](#hidekey)
  - [.detectLocale(boolean)](#detectlocaleboolean)
  - [.env([prefix])](#envprefix)
  - [.epilog(str)](#epilogstr)
  - [.epilogue(str)](#epiloguestr)
  - [.example(cmd, desc)](#examplecmd-desc)
  - [.exitProcess(enable)](#exitprocessenable)
  - [.exit(code, err)](#exitcode-err)
  - [.fail(fn)](#failfn)
  - [.getCompletion(args, done);](#getcompletionargs-done)
  - [.global(globals, [global=true])](#globalglobals-globaltrue)
  - [.group(key(s), groupName)](#groupkeys-groupname)
  - [.help()](#help)
  - [.help([option | boolean])](#helpoption--boolean)
  - [.help([option, [description]])](#helpoption-description)
  - [.implies(x, y)](#impliesx-y)
  - [.locale()](#locale)
  - [.locale(locale)](#localelocale)
  - [.middleware(callbacks, [applyBeforeValidation])](#middlewarecallbacks-applybeforevalidation)
  - [.nargs(key, count)](#nargskey-count)
  - [.normalize(key)](#normalizekey)
  - [.number(key)](#numberkey)
  - [.option(key, [opt])](#optionkey-opt)
  - [.options(key, [opt])](#optionskey-opt)
  - [.parse([args], [context], [parseCallback])](#parseargs-context-parsecallback)
  - [.parsed](#parsed)
  - [.parserConfiguration(obj)](#parserconfigurationobj)
  - [.pkgConf(key, [cwd])](#pkgconfkey-cwd)
  - [.positional(key, opt)](#positionalkey-opt)
  - [.recommendCommands()](#recommendcommands)
  - [.require(key, [msg | boolean])](#requirekey-msg--boolean)
  - [.required(key, [msg | boolean])](#requiredkey-msg--boolean)
  - [.requiresArg(key)](#requiresargkey)
  - [.reset() [DEPRECATED]](#reset-deprecated)
  - [.scriptName($0)](#scriptname0)
  - [.showCompletionScript()](#showcompletionscript)
  - [.showHelp([consoleLevel | printCallback])](#showhelpconsolelevel--printcallback)
  - [.showHelpOnFail(enable, [message])](#showhelponfailenable-message)
  - [.showHidden()](#showhidden)
  - [.showHidden([option | boolean])](#showhiddenoption--boolean)
  - [.showHidden([option, [description]])](#showhiddenoption-description)
  - [.skipValidation(key)](#skipvalidationkey)
  - [.strict([enabled=true])](#strictenabledtrue)
  - [.strictCommands([enabled=true])](#strictcommandsenabledtrue)
  - [.string(key)](#stringkey)
  - [.updateLocale(obj)](#updatelocaleobj)
  - [.updateStrings(obj)](#updatestringsobj)
  - [.usage(<message|command>, [desc], [builder], [handler])](#usagemessagecommand-desc-builder-handler)
  - [.version()](#version)
  - [.version([version|boolean])](#versionversionboolean)
  - [.version([option], [description], [version])](#versionoption-description-version)
